...
**Hardening progress (12 August 2026):** the registered-root/CUE containment, backup/snapshot safety, DSF/WAV validation, playback repeated-work cleanup, chunked background fingerprinting, startup retry, and scheduled publication/backup isolation slices are complete and independently tested. The remaining gate is bounded network/error handling and final exit verification; the visual redesign remains blocked until those checks pass.
