...
- Track rating UI complete: schema 10 stores the same optional 1–5 scale on tracks; the Mac track editor updates it, album detail displays it, and published read-only track data includes it.
