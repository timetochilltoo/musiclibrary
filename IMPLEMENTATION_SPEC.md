...
- Confirmed digital-asset foundation complete: migration 6, explicit idempotent creation of albums/discs/tracks/assets from approved proposals, root-relative embedded-tag provenance, and calculated missing/offline/partial Library Health. Library Health also flags active albums with no selected front artwork. No asset is copied, moved, relinked, or deleted.
- Local playback foundation complete: AVFoundation shared-output player, root-authorized/file-verified asset resolution, persisted disc queue, previous/next/repeat/shuffle/volume/pause/stop/seek controls, and a Now Playing surface. Playback failures leave queue and catalogue records unchanged; failed resume or queue transitions stop safely and present local feedback.
