...
- Twenty-six automated domain/persistence tests across four suites, last verified with `swift test` on 22 July 2026.
...
The next coding slice is **snapshot publisher**. Do not expose the live SQLite database to companion clients.
