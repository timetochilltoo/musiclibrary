...
The last verified baseline contains 53 tests in 5 suites, run with a rebuilt `swift test` on 26 July 2026. Run `swift test`; do not rely on this handoff alone.
