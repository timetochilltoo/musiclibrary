...
Add a later review action for safely removing obsolete catalogue references only after the user has reviewed affected albums/tracks. Keep identities/order stable, make every change explicit and transactional, and keep corrections catalogue-only. Do not begin artwork migration or snapshot-to-master reconstruction without a new reviewed design.
