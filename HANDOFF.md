...
The macOS sidebar includes a Contributors section, backed by a deterministic name/sort-name query. It is a browse surface; contributor corrections remain available through existing album/track credit editing.
