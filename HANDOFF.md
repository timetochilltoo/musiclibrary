...
**Artwork storage decision (23 July 2026):** copy selected artwork into managed catalogue storage. This makes it resilient to moved source folders and eligible for master backups and later iPad publication. The existing local-path artwork feature is transitional; do not claim artwork portability until it has been migrated.
