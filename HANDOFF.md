...
Album-detail removal and disc-reorder actions surface failures through the app error alert rather than silently ignoring them.
...
The macOS sidebar includes a Contributors section, backed by a deterministic name/sort-name query. Selecting a contributor lists all active albums where they hold either an album or track credit. Contributor corrections remain available through existing album/track credit editing.
